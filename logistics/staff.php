...
<body>
    ...
    <!-- Main Content -->
    <main>
        <div class="tile" onclick="window.location.href='./staff/driverman.php';">
            <h2>Driver Management</h2>
            <p>Manage and view drivers.</p>
        </div>
        <div class="tile" onclick="window.location.href='./staff/viewhire.php';">
            <h2>View Hires</h2>
        ...
        <div class="tile" onclick="window.location.href='./staff/view_assigned.php';">
            <h2>Assigned Hires</h2>
            <p>Assign Drivers to Requests.</p>
        </div>
        <div class="tile" onclick="window.location.href='./staff/driveractivity.php';">
            <h2>Driver Activity</h2>
            <p>View Driver Activity.</p>
        </div>
        <div class="tile" onclick="window.location.href='./staff/settings.php';">
            <h2>Profile</h2>
