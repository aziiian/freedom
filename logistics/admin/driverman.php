...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_driver'])) {
    ...
    $insert_sql = "INSERT INTO drivers (regno, Full_name, cartype, location, username) 
                   VALUES (?, ?, ?, ?, ?)";

    $stmt = $conn->prepare($insert_sql);
    $stmt->bind_param("sssss", $regno, $full_name, $cartype, $location, $username);
...
<header>
  ...
  <div class="container">
    ...
    <form method="POST" action="">
      ...
      <br>
      <button type="button" class="btn-secondary" onclick="window.location.href='../admin.php';">Return to Admin Panel</button>
    </form>
